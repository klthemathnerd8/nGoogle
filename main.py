def nGoogle():
  ...
  def about():
    ...
    print(f"{space}{Fore.BLUE}S{Fore.RED}O{Fore.LIGHTYELLOW_EX}C{Fore.BLUE}I{Fore.LIGHTGREEN_EX}A{Fore.RED}L{Fore.BLUE}S{Fore.WHITE}")
    
    sp(f"{Fore.RED}● {Fore.WHITE}YOUTUBE: {Fore.LIGHTBLUE_EX} https://www.youtube.com/channel/UCcIuJXUhGSWCbFKL3zDme3Q/ \n{Fore.RED}● {Fore.WHITE}INSTAGRAM: {Fore.LIGHTBLUE_EX} https://www.instagram.com/ifreakuyt/ \n{Fore.RED}● {Fore.WHITE}GITHUB: {Fore.LIGHTBLUE_EX} https://github.com/iFreaku/")
